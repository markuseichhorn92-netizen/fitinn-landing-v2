  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6">
        <div className="feature-card corner-decorator p-10 md:p-14 text-center animate-scale-in">
          ...
          <span className="text-sm text-primary uppercase tracking-widest font-semibold">Unser Versprechen</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {guarantees.map((g, i) => (
              <div key={i} className="flex flex-col items-center text-center gap-3 animate-fade-up" style={{ animationDelay: `${i * 0.1}s` }}>
