...
import { Activity, ChartLine, LucideIcon, Utensils } from 'lucide-react'
        ...
        <div className="mx-auto grid gap-4 lg:grid-cols-2">
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Dein Stoffwechsel im Detail – Start, Mitte & Ende des Programms."
              />
            </CardHeader>
            ...
            <div className="relative mb-6 border-t border-dashed sm:mb-0">
              ...
              <div className="aspect-[76/59] p-1 px-6">
                <DualModeImage
                  darkSrc="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=1200&q=80"
                  lightSrc="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=1200&q=80"
                  alt="Körperanalyse"
                  width={1207}
                  height={929}
                />
          ...
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Kein Verzicht – lecker essen und trotzdem abnehmen."
              />
            </CardHeader>
            ...
            <CardContent>
              <div className="relative mb-6 sm:mb-0">
                ...
                <div className="aspect-[76/59] border rounded-lg overflow-hidden">
                  <DualModeImage
                    darkSrc="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=1200&q=80"
                    lightSrc="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=1200&q=80"
                    alt="Gesundes Essen"
                    width={1207}
                    height={929}
                  />
          ...
          <FeatureCard className="p-6 lg:col-span-2">
            <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">
              8 Wochen. 3 Analysen. Ein Ziel: Dein Wunschgewicht.
            </p>
