...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung – FIT-INN Trier | happyfigur',
  robots: 'noindex',
}
  ...
  return (
    <LegalPage title="Datenschutzerklärung">
      ...
      <p>
        ...
        Drittstaaten erfolgt die Datenverarbeitung außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Sofern Sie
        in die Speicherung von Cookies oder in den Zugriff auf Informationen in Ihr Endgerät eingewilligt haben, erfolgt
        die Datenverarbeitung zusätzlich auf Grundlage von § 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.
        Sind Ihre Daten zur Vertragserfüllung oder zur Durchführung vorvertraglicher Maßnahmen erforderlich, verarbeiten
        wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern
        diese zur Erfüllung einer rechtlichen Verpflichtung erforderlich sind auf Grundlage von Art. 6 Abs. 1 lit. c
      ...
      <p>
        ...
        erforderlich ist, wenn wir gesetzlich hierzu verpflichtet sind, wenn die Weitergabe auf Grundlage unseres
        berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgt oder wenn eine sonstige Rechtsgrundlage die
      ...
      <p>
        <strong>
          ...
          Profiling. Werden Ihre personenbezogenen Daten verarbeitet, um Direktwerbung zu betreiben, so haben Sie das
      ...
      <p>
        Sie haben das Recht, die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Das Recht
      ...
      <ul>
        ...
        <li>Wenn Sie einen Widerspruch nach Art. 21 Abs. 1 DSGVO eingelegt haben, muss eine Abwägung zwischen Ihren und
          ...
          das Recht, die Einschränkung der Verarbeitung zu verlangen.</li>
      </ul>
      ...
      <p>
        ...
        Ihnen erwünschter Funktionen oder zur Optimierung der Website erforderlich sind, werden auf Grundlage von Art. 6
        Abs. 1 lit. f DSGVO gespeichert, sofern keine andere Rechtsgrundlage angegeben wird. Der Websitebetreiber hat
        ein berechtigtes Interesse an der Speicherung von technisch notwendigen Cookies zur technisch fehlerfreien und
      ...
      <p>
        Wenn Sie uns per Kontaktformular oder über das Buchungsformular für das Probetraining Anfragen zukommen lassen,
        werden Ihre Angaben aus dem Formular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der
      ...
      <p>
        Wenn Sie über unser Buchungsformular ein Probetraining buchen, werden die von Ihnen eingegebenen Daten (Name,
        E-Mail, Telefonnummer, Geschlecht, Geburtsdatum, Adresse) an die Magicline Connect API der Magicline GmbH
        übermittelt. Dies dient der Terminbuchung und Kundenverwaltung in unserem Studiomanagementsystem. Die
        Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung/vorvertragliche Maßnahmen).
      </p>

      <h2>5. Analyse-Tools und Werbung</h2>
      <p>
        Auf dieser Website werden derzeit keine Analyse-Tools oder Werbetracking-Dienste eingesetzt.
      </p>

      <h2>6. Ihre Rechte im Überblick</h2>
      <table>
        <thead>
          <tr>
            <th>Recht</th>
        ...
        <tbody>
          <tr>
            <td>Auskunft</td>
            <td>Sie können Auskunft über Ihre gespeicherten Daten verlangen.</td>
          </tr>
          <tr>
            <td>Berichtigung</td>
            <td>Unrichtige Daten können Sie berichtigen lassen.</td>
          </tr>
          <tr>
            <td>Löschung</td>
            <td>Unter bestimmten Voraussetzungen können Sie die Löschung verlangen.</td>
          </tr>
          <tr>
            <td>Einschränkung</td>
          ...
          <tr>
            <td>Widerspruch</td>
            <td>Sie können der Verarbeitung jederzeit widersprechen.</td>
          </tr>
          <tr>
            <td>Beschwerde</td>
            <td>Sie können sich bei der Aufsichtsbehörde beschweren.</td>
          </tr>
        </tbody>
      </table>
